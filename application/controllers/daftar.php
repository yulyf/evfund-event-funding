	...
	<div class="navbar navbar-inverse navbar-static-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="login"><img src="assets/images/logo.png" alt="Progressus HTML5 template"></a>
			</div>
...
<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<p class="text-center text-muted">Jika sudah punya akun, <a href="login">Login</a> </p>
							<hr>
